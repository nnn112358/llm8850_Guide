...
ソース: https://docs.m5stack.com/ja/guide/ai_accelerator/llm-8850/m5_llm_8850_qwen2.5_0.5b

Qwen2.5-0.5B-Instruct-GPTQ-Int4 は Alibaba Cloud が開発した約5億パラメータの軽量言語モデルの量子化版です。GPTQ Int4 量子化により、LLM-8850 上で効率的な推論が可能です。
